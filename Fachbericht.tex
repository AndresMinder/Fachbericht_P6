...
\include{parts/einleitung/Einleitung}
\include{parts/einleitung/Auftragsbeschreibung}
\include{parts/einleitung/Ziele}
\include{parts/einleitung/Konzept}

\part{Firmware}
\label{part:Firmware}
\include{parts/firmware/chapters/Interfaces/Interfaces}
\include{parts/firmware/chapters/Firmware/Firmware}

\part{Hardware}
\label{chap:Hardware}
\include{parts/hardware/Uebersicht}
\include{parts/hardware/MCU}
\include{parts/hardware/RTC}
\include{parts/hardware/Sensoren}
\include{parts/hardware/Datenspeicherung}
\include{parts/hardware/Kommunikationsmodule}
\include{parts/hardware/Energieversorgung}
\include{parts/hardware/PCB}

\part{Abschluss}
\label{part:AbschliessenderTeil}
\include{parts/abschluss/Konzeptvalidierung}
\include{parts/abschluss/Schluss}

\newpage


\include{parts/Authentizitaetserklaerung}
%%---BIBLIOGRAPHY------------------------------------------------------------------------
\part{Referenzen}
{\sloppypar
